...
import de.openknowledge.jaxrs.versioning.resources.VersionMediaTypeParameterAddressResource;
...
public class VersionMediaTypeParameterFeatureTest {
  ...
  public void getAddressV20(@ArquillianResource URL url) throws IOException {
    ...
    connection.setRequestProperty("Accept", "application/json;version=v2");
  ...
  public void postAddressV20(@ArquillianResource URL url) throws IOException {
    ...
    connection.setRequestProperty("Content-Type", "application/json;version=v2");
