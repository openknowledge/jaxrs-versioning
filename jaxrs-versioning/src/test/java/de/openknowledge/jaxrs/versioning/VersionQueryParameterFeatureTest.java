...
import de.openknowledge.jaxrs.versioning.resources.VersionQueryParameterAddressResource;
...
public class VersionQueryParameterFeatureTest {
  ...
  public void postAddressV20(@ArquillianResource URL url) throws IOException {
    HttpURLConnection connection = (HttpURLConnection)new URL(url, "addresses/42?version=v2").openConnection();
