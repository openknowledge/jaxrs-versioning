...
import de.openknowledge.jaxrs.versioning.resources.VersionedMediaTypeAddressResource;
...
public class VersionedMediaTypeFeatureTest {
  ...
  public void postAddressV20(@ArquillianResource URL url) throws IOException {
    ...
    connection.setRequestProperty("Content-Type", "application/vnd+de.openknowledge.jaxrs.versioning+json+v2");
