[![Build Status](https://travis-ci.org/openknowledge/jaxrs-versioning.svg?branch=master)](https://travis-ci.org/openknowledge/jaxrs-versioning) [![sonarcloud](https://sonarcloud.io/api/project_badges/measure?project=de.openknowledge.jaxrs%3Ajaxrs-versioning&metric=vulnerabilities)](https://sonarcloud.io/dashboard?id=de.openknowledge.jaxrs%3Ajaxrs-versioning)
